/**
 * OpenTelemetry Initialization for Backend Service
...
export function initializeTelemetry() {
  ...
  try {
    ...
    const resource = new Resource({
      [SemanticResourceAttributes.SERVICE_NAME]: 'robert-backend',
    ...
    console.log('✅ OpenTelemetry initialized for backend service');
    console.log(`   - Traces: Jaeger (${process.env.JAEGER_ENDPOINT || 'http://localhost:14268/api/traces'})`);
    console.log(`   - Metrics: Prometheus (port ${process.env.PROMETHEUS_PORT || '9464'})`);
