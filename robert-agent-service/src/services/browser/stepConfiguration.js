...
export const STEP_NAMES = {
  ...
  LOOKUP_CONTACT: 'lookupContact',              // Existing workflow only
  ...
  'ITM': {
    'Introduction to Motorcycling': {
      existing: {
        ...
        [STEP_NAMES.LOOKUP_CONTACT]: 8,
        [STEP_NAMES.FILL_CONTACT_DETAILS]: 9,
        [STEP_NAMES.PROCESS_PAYMENT]: 10,
        [STEP_NAMES.SEND_PAYMENT_REQUEST]: 10, // Alternative to PROCESS_PAYMENT
        [STEP_NAMES.SEND_CONFIRMATION]: 11,
        [STEP_NAMES.SEND_TERMS]: 12,
        [STEP_NAMES.SEND_SMS]: 13
      },
      new: {
        [STEP_NAMES.CHECK_AVAILABILITY]: 1,
        [STEP_NAMES.AUTHENTICATE]: 2,
        ...
        [STEP_NAMES.SEND_PAYMENT_REQUEST]: 8, // Alternative to PROCESS_PAYMENT
