/**
 * OpenTelemetry Metrics Service for Agent Service
...
export function initializeMetrics() {
  try {
    ...
    meter = metrics.getMeter('robert-agent-service', '1.0.0');
    ...
    console.log('✅ Metrics service initialized for agent service');
  } catch (error) {
