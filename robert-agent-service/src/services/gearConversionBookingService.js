    ...
    try {
      ...
      if (workflowType === 'existing') {
        ...
        try {
          ...
          await commonSteps.sendBookingConfirmationEmail(page, this.screenshotsDir, 'gear-conversion');
        ...
        try {
          ...
          await commonSteps.sendSMSConfirmation(page, this.screenshotsDir, 'gear-conversion');
