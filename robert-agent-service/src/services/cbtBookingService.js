    ...
    try {
      ...
      if (!sessionDetails) {
        ...
        sessionDetails = {
          ...
          course: 'CBT - Compulsory Basic Training',
      ...
      if (workflowType === 'existing') {
        ...
        try {
          ...
          await commonSteps.sendBookingConfirmationEmail(page, this.screenshotsDir, 'cbt');
        ...
        try {
          ...
          await commonSteps.sendSMSConfirmation(page, this.screenshotsDir, 'cbt');
