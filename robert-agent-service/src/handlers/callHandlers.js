...
import { ensureCallRecordCallerIdentity, setDefaultRecordingConsent } from "../services/callRecordPersistenceService.js";
...
async function setInboundCallConsent(callSid, callType = 'Twilio') {
    await setDefaultRecordingConsent(callSid, callType);
}
